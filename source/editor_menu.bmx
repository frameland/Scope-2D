...
'--------------------------------------------------------------------------	
	Method Init( editor:TEditor )
		...
		CreateMenu( "", 0, edit )
		CreateMenu( "Flip Horizontally", M_FLIP_HORIZONTAL, edit, KEY_D, MODIFIER_COMMAND|MODIFIER_SHIFT)
		CreateMenu( "Flip Vertically", M_FLIP_VERTICAL, edit, KEY_F, MODIFIER_COMMAND|MODIFIER_SHIFT)
		CreateMenu( "", 0, edit )
